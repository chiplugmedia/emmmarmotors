...
function sendMail($email, $fullname, $message, $subject, $type="") {
    $sitelink = "https://localhost/emmmarmotors";
        ...
        <style>
            * {
            ...
            .email-button {
                ...
                background: linear-gradient(49deg, #1565c0, #1e88e5);
                color: #ffffff;
                padding: 14px 32px;
...
.contact-link img {
            ...
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <div class='contact-info'>
                        <h3 style='color: #0d47a1; margin-bottom: 15px;'>Get In Touch</h3>
                    ...
                    <div style='text-align: center; margin: 30px 0; padding: 20px; background: linear-gradient(135deg, #f4f8fc 0%, #dbe8fb 100%); border-radius: 8px;'>
                        <p style='color: #0d47a1; font-weight: 600;'>Thank you for choosing Hirelink!</p>
 ...
 <p>
    ...
    // Email Verification Template (verify email address, link based)
        ...
        $body .= "
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <div style='text-align: center;'>
                        <a href='https://$sitelink/verify-email.php?tkn=$verifyToken' class='email-button'>
                            Verify Email
                        </a>
                    </div>
    ...
    // Account Verification Template (identity / KYC verification code)
        ...
        $body .= "
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <div class='email-content'>
                        <p>Use the verification code below to confirm your account and complete your verification process.</p>
                    </div>

                    <div class='info-box' style='text-align:center;'>
                        <div class='info-label'>Your Verification Code</div>
                        <div class='info-value' style='font-size: 28px; letter-spacing: 4px; font-weight: 700; color: #0d47a1;'>$code</div>
                    </div>

                    <div class='warning-text'>
                        <p><strong>Important:</strong> This code will expire in 10 minutes. Never share it with anyone.</p>
                    </div>

                    <div class='info-box'>
                        <p>If you didn't request account verification, please contact our support team immediately.</p>
                    </div>
                </div>
        ...
        $body .= "
            <div class='email-container'>
                ...
                <div class='email-body'>
                    ...
                    <div class='info-box' style='text-align:center;'>
                        <div class='info-label'>One-Time Code</div>
                        <div class='info-value' style='font-size: 28px; letter-spacing: 4px; font-weight: 700; color: #0d47a1;'>$otp</div>
                    </div>

                    <div class='warning-text'>
                        <p><strong>Security Alert:</strong> This code expires in 10 minutes. Your transaction PIN protects your funds &mdash; never share it with anyone, including our support staff.</p>
                    </div>

                    <div class='info-box'>
                        <p>If you didn't request a transaction PIN change, please secure your account and contact support right away.</p>
                    </div>
                </div>
    ...
    // Deposit Confirmation Template
        ...
        $datetime = $message['datetime'];
        $method = isset($message['method']) ? $message['method'] : 'N/A';
        ...
        $body .= "
            <div class='email-container'>
                ...
                <div class='email-body'>
                    <h1 class='email-title'>Deposit Notification</h1>

                    <p class='email-greeting'>Hello, $fullname</p>

                    <div class='email-content'>
                        <p>We're writing to let you know about a deposit on your account.</p>
                    </div>
                    ...
                    <div class='success-text'>
                        <p>Thank you for funding your account. You can view full details from your dashboard.</p>
                    </div>

                    <div style='text-align: center;'>
                        <a href='https://$sitelink/dashboard.php' class='email-button'>
                            View Dashboard
                        </a>
                    </div>
                </div>
    ...
    // Withdrawal Confirmation Template
        ...
        $body .= "
            <div class='email-container'>
                ...
                <div class='email-body'>
                    <h1 class='email-title'>Withdrawal Notification</h1>

                    <p class='email-greeting'>Hello, $fullname</p>

                    <div class='email-content'>
                        <p>We're writing to let you know about a withdrawal request on your account.</p>
                    </div>
                    ...
                    <div class='warning-text'>
                        <p><strong>Security Alert:</strong> If you didn't initiate this withdrawal, please contact our support team immediately and secure your account.</p>
                    </div>
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'chiplugtv@gmail.com';
        $mail->Password = 'axkgwgludpnvocjn';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;
        
        $mail->setFrom('info@aimvest.com.ng', 'Emmmar Motors');
        $mail->addAddress($email, $fullname);
        $mail->addReplyTo('info@aimvest.com.ng', 'Emmmar Motors Support');
