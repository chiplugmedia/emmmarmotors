...
<div class="container-fluid">
    ...
    <div class="layout-specing">
        ...
        <div class="d-md-flex justify-content-between align-items-center">
            ...
            <h5 class="mb-0 text-dark fw-bold">General Setting</h5>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mt-4">
                ...
                <div class="card border-0 rounded shadow">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-dark fw-bold text-md-start text-center mb-0">Personal Details :</h5>
            ...
            <div class="col-lg-4 mt-4">
                ...
                <div class="card border-0 rounded shadow p-4">
                    ...
                    <h5 class="mb-0 text-dark fw-bold">Bank Details :</h5>
            ...
            <div class="col-lg-4 mt-4">
                ...
                <div class="card border-0 rounded shadow p-4">
                    ...
                    <h5 class="mb-0 text-dark fw-bold">Site Details :</h5>
