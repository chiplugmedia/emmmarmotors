...
<div class="page-wrapper landrick-theme toggled">
        ...
        <div class="top-header">
            <div class="header-bar d-flex justify-content-between border-bottom">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a id="close-sidebar" class="btn btn-icon btn-soft-dark" href="javascript:void(0)">
    ...
    <li class="list-inline-item mb-0 ms-1">
        <div class="dropdown dropdown-primary">
            <button type="button" class="btn btn-soft-dark dropdown-toggle p-0"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="/emmmarmotors/mysite/bandogreen.jfif" class="avatar avatar-ex-small rounded" alt="">
            </button>
            <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3"
                style="min-width: 200px;">
                <a class="dropdown-item d-flex align-items-center pb-3" href="setting">
                    <img src="/emmmarmotors/mysite/bandogreen.jfif" class="avatar avatar-md-sm rounded-circle border shadow" alt="">
